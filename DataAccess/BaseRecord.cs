...
namespace Bigwoo.DataAccess
{
    ...
    public class BaseRecord
    {
        ...
        /// 
        /// </summary>
        protected readonly string RECORD_ID_FIELD_NAME = "RecordId";
        /// <summary>
        /// 
        /// </summary>
        protected readonly string RECORD_KEY_FIELD_NAME = "RecordKey";
        #endregion
        ...
        /// 
        /// </summary>
        protected Guid _recordKey = Guid.Empty;
        #endregion
        ...
        /// </summary>
        protected internal BaseRecord() 
        {
            MarkIsNewRecord();

            if (false == AssemblyUtility.HasAttribute(typeof(BigWoo.DataAccess.Attributes.ExcludeRecordKeyAttribute), GetType()))
                if (Guid.Empty == _recordKey)
                    _recordKey = Guid.NewGuid();
        }
        ...
        protected internal BaseRecord(int recordId)
        {
            _recordID = recordId;
        }
        ...
        protected internal BaseRecord(Guid recordKey)
        {
        ...
        /// 
        /// </summary>
        protected internal virtual void LoadPrep(SqlCommand cmd) { throw new NotImplementedException(); }
        
        /// <summary>
        /// Override this method if the consumer is allowed to create new records
        /// </summary>
        /// <param name="cmd">SqlCommand</param>
        protected internal virtual void InsertPrep(SqlCommand cmd) { throw new NotImplementedException(); }
        ...
        /// </summary>
        /// <param name="cmd">SqlCommand</param>
        protected internal virtual void UpdatePrep(SqlCommand cmd) { throw new NotImplementedException(); }
        ...
        /// </summary>
        /// <param name="cmd">SqlCommand</param>
        protected internal virtual void DeletePrep(SqlCommand cmd) { throw new NotImplementedException(); }
        ...
        protected internal virtual void Validate() 
        {
            if (false == AssemblyUtility.HasAttribute(typeof(BigWoo.DataAccess.Attributes.ExcludeRecordKeyAttribute), GetType()))
                if (Guid.Empty == _recordKey)
                    throw new DataNotValidException("Record Key was never set to a valid guid.");
        }
        ...
        protected internal virtual void Load(SqlDataReader reader) { throw new NotImplementedException(); }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="recordId">int</param>
        protected internal virtual void PostSave(int recordId) 
        {
            // we only update our record id if we know it is not currently
            // a valid record id
            if (-1 == _recordID)
                _recordID = recordId;
        ...
        /// <returns></returns>
        public static bool IsValidRecordID(BaseRecord record)
        {
            int recordID = BaseRecord.RecordID(record);
        ...
        /// <param name="record"></param>
        /// <returns></returns>
        public static bool IsValidRecordKey(BaseRecord record)
        {
            Guid recordKey = record._recordKey;

            if (Guid.Empty != recordKey)
                return true;
